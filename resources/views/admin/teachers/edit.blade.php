...
<div class="card">
	<div class="card-header"><strong>Edit Teacher</strong></div>
	<div class="card-body">
		@include('admin.includes.flashMsg')
		<form class="form-horizontal" method="POST" action="{{ url('admin/teachers/'.$teacher->id)}}" enctype="multipart/form-data">
			@method('PATCH')
